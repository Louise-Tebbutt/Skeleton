...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnReturnToMM_Click" runat="server" OnClick="btnReturnToMM_Click_Click" Text="Return To Main Menu" style="position:absolute; top:300px; left:300px;" />
